...
public:
    ...
    {
        decoder.setVersion( v, dxfFormat );
    }
    void setCodePage( std::string* c )
    {
        decoder.setCodePage( c, true );
    }
    std::string getCodePage()
    {
        return decoder.getCodePage();
    }
    void setIgnoreComments( const bool bValue )
    {
        m_bIgnoreComments = bValue;
    };
...
{
public:
    dxfReaderBinary( std::ifstream* stream )
        : dxfReader( stream )
    {
        skip = false;
    }
...
{
public:
    dxfReaderAscii( std::ifstream* stream )
        : dxfReader( stream )
    {
        skip = true;
    }
