...
#ifndef __DxfInterFace__
#define __DxfInterFace__

#include <iostream>
#include <algorithm>
#include "Libraries/libdxfrw/drw_interface.h"
#include "Libraries/libdxfrw/libdxfrw.h"
#include "Libraries/libdxfrw/libdwgr.h"
#include "DxfData.h"
...
public:
	...
	{
		for (std::list<DRW_Entity*>::const_iterator it = cData->mBlock->ent.begin(); it != cData->mBlock->ent.end();
			++it)
			writeEntity(*it);
	}
